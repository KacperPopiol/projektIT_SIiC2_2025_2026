const chatThemes = [
	...
	},
	{
		...
		variables: {
			...
			backgroundImage: 'radial-gradient(circle at 20% 20%, rgba(57,160,237,0.35), transparent 60%), radial-gradient(circle at 80% 30%, rgba(172,126,241,0.25), transparent 55%)',
			incomingBubbleColor: 'rgba(255,255,255,0.08)',
...
const chatThemesMap = chatThemes.reduce((acc, theme) => {
	acc[theme.key] = theme
	return acc
}, {})
